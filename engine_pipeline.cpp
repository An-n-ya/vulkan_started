...
namespace engine
{
    ...
    {
        assert(configInfo.pipelineLayout != VK_NULL_HANDLE && "Cannot not create graphics pipeline: no pipelineLayout provided");
        assert(configInfo.renderPass != VK_NULL_HANDLE && "Cannot not create graphics pipeline: no renderPass provided");
